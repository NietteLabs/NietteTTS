...
iconv --from-code=ISO-8859-9 --to-code=UTF-8 1000-sentences-thls-dataset/sentences.txt | gawk '{print tolower($0)}' | sed "s/\"/\'/g" | sed "s/ë/e/g" > 1000-sentences-thls-dataset/sentence_utf8.txt
